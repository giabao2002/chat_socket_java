...
public class Client {
	...
	private int timeOut = 10000; // thời gian trả lời mỗi yêu cầu là 10s
	...
	public void request() throws Exception {
		...
		// just for test
		System.out.println("toantoan" + msg); // kiểm tra sever trả về cho user
	...
	public void intialNewChat(String IP, int host, String guest) throws Exception {
		...
		if (msg.equals(Tags.CHAT_DENY_TAG)) {
			MainFrame.request("Bạn của bạn từ chối kết nối với bạn!", false);
			connclient.close();
			return;
		}
		// not if
