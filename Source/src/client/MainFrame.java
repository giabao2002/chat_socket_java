	...
	private void connectChat() {
		...
		if (n == 0) {
			...
			if (name.equals(nameUser)) {
				Tags.show(this, "Phần mềm này không hỗ trợ chức năng tự trò chuyện.", false);
				return;
			}
			...
			Tags.show(this, "Bạn không được tìm thấy. Vui lòng đợi để cập nhật danh sách bạn bè của bạn", false);
		}
	}
